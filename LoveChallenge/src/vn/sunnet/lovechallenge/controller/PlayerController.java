...
public class PlayerController {
	...
	public void update(float delta) {
		...
		// position
		player.getVeloctity().add(player.getAccelation().x * delta,
				player.getAccelation().y * delta);
		player.getPosition().add(player.getVeloctity().x * delta,
				player.getVeloctity().y * delta);
